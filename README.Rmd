...
This model includes three parameter Schnute production^[[cite](link.pdf)], natural mortality, 
...
Logistic (Schaefer) Model `\gamma=1`, Ricker Model `\gamma\rightarrow0`, Beverton-Holt `\gamma=-1`
